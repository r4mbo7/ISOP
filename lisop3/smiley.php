<?php
	...
	if (preg_match("#:bleu:#", $commentaire) AND preg_match("#:/bleu:#", $commentaire) )
	{
	$smile=":bleu:";
	$smile_png="<spam style='color:blue'>";
	$commentaire=str_replace($smile, $smile_png, $commentaire);
	...
	if (preg_match("#:rouge:#", $commentaire) AND preg_match("#:/rouge:#", $commentaire) )
	{
	$smile=":rouge:";
	$smile_png="<spam style='color:red'>";
	$commentaire=str_replace($smile, $smile_png, $commentaire);
	...
	if (preg_match("#:vert:#", $commentaire) AND preg_match("#:/vert:#", $commentaire) )
	{
	$smile=":vert:";
	$smile_png="<spam style='color:green'>";
	$commentaire=str_replace($smile, $smile_png, $commentaire);
