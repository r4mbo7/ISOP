...
<div id="menu">
	<ul class="niveau1">
		...
		<li class="sousmenu">
			...
			<a href="club.php">Clubs/UNSS</a>
			
			<ul class="niveau2">
				
				<li><a href="club.php?index=1">UNSS</a></li>
				<li><a href="club.php?index=2">Théâtre</a></li>
				<li><a href="club.php?index=3">Astronomie</a></li>
				<li><a href="club.php?index=4">Lécture</a></li>
