...
try
{
    ...
    <div class="titre">
        <h3 <?php if($donnees['block']==1){echo "style='color:#C0C0C0'";} else{}?> >
			...
			{?>
			<a href="favori_topic_post.php?billet=<?php echo $donnees['id'];?>&amp;num=4">Ajouter ce topics aux Favoris</a>
			<?php
			}
			else
			{
	...
	{?>
	<br/>
	<a href="supr_topic.php?id=4&amp;topic=<?php echo $donnees['id'];?>">Suprimer le topic</a>
	<?php
	}?>
	...
	<div class="commentaire">
		...
		else
		{
			...
			else
			{
				...
				{
					echo "<strong><a href='Pageperso.php?id=" .$donnees['id_auteur'] ."'>" .htmlspecialchars($donnees['auteur']) .'</a> /' .htmlentities($donnees['titre_auteur']) ."\</strong> (" .$donnees['classe'] .")  <a href='supr_commentaire_ea.php?id=" .$donnees['id'] ."' style='color:black'>Supprimer</a>";
				}
				else
				{
	...
	{
		echo " <a style='color:#C0C0C0' href='supr_commentaire_ea.php?id=" .$donnees['id'] ."'>Supprimer</a>";
	}
	else
	{
		echo ' ';
