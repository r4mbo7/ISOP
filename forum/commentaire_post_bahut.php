...
$req = $bdd->prepare("INSERT INTO commentaires_bahut (id_billet, auteur, id_auteur, titre_auteur, classe, commentaire, date_commentaire) VALUES(:id_billet, :auteur, :id_auteur, :titre_auteur, :classe, :commentaire, NOW())" );
$req->execute(array(
		'id_billet' => $id_billet, 
		'auteur' => $prenom,
		'id_auteur' => $id_auteur,
	...
	header('Location: commentaires_bahut.php?billet=' .$id_billet .'&page=' .$_GET['page']);
}
?>