...
try
{
    ...
    <div class="titre">
        <h3 <?php if($donnees_topic['block']==1){echo "style='color:#C0C0C0'";} else{}?> >
			...
			{?>
			<a href="favori_topic_post.php?billet=<?php echo $donnees_topic['id'];?>&amp;num=1">Ajouter ce topics aux Favoris</a>
			<?php
			}
			else
			{
		...
		{ 
			...
			include("smiley.php");
			?>
			<p><?php echo nl2br(htmlspecialchars(stripslashes($commentaire))); ?></p>
			<?php
			if(!empty($donnees_topic['image']))
			{?>
			<img src="images/<?php echo $donnees_topic['image']?>" />
	...
	{?>
	<br/>
	<a href="supr_topic.php?id=1&amp;topic=<?php echo $donnees_topic['id'];?>">Suprimer le topic</a>
	<?php
	}?>
	...
	<div class="commentaire">
		...
		<div class="info_auteur">
			...
			{
				echo "<br/><a style='color:#C0C0C0' href='supr_commentaire_site.php?id=" .$donnees['id'] ."'>Supprimer</a>";
			}
