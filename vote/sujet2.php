...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" > 
	...
	body
	{
		background-image: url(images/fond_votela.png);
	...
	<body>
			   <p>
				<div id="tcool">
				<form method="post" action="vote_f_cool.php"> 
		       <label for="election">Vote pour la plus cool.</label> 
			   </div>
		       <select name="cool" id="cool"> 
				...
				$reponse = $bdd->query("SELECT prenom FROM membre WHERE sexe='Femme' AND classe='2nd' OR sexe='Femme' AND classe='1ere'  OR sexe='Femme' AND classe='Term' ORDER BY ID DESC");
		   ...
		   <p> 
				<div id="tsexy">
				<form method="post" action="vote_f_sexy.php"> 
		       <label for="election">Vote pour la plus sexy.</label>
			   </div>
		   ...
		   <p> 
				<div id="tclass">
				<form method="post" action="vote_f_sape.php"> 
		       <label for="election">Vote pour la plus class.</label>
			   </div>
		   ...
		   <p> 
				<div id="tdej">
				<form method="post" action="vote_f_dejante.php"> 
		       <label for="election">Vote pour la plus d&eacutejant&eacute.</label>
			   </div>
		...
		<a href="../Categos.php">Page r&eacutesultats.<a>
	</body> 
</html> 